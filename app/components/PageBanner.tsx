...
const PAGE_BANNER_SVG = {
  ...
  shape3: (
    <svg xmlns="http://www.w3.org/2000/svg" width="515px" height="515px">
      <defs>
        <linearGradient id="PSgrad_0b" x1="0%" x2="89.879%" y1="0%" y2="43.837%">
          <stop offset="0%" stopColor="rgb(67,186,255)" stopOpacity={1} />
          <stop offset="100%" stopColor="rgb(113,65,177)" stopOpacity={1} />
        </linearGradient>
      </defs>
      ...
      <path fill="url(#PSgrad_0b)" d="M19.529,202.280 L230.531,14.698 C254.559,-6.661 291.353,-4.498 312.714,19.528 L500.295,230.531 C521.656,254.558 519.493,291.353 495.466,312.713 L284.463,500.295 C260.436,521.655 223.641,519.492 202.281,495.465 L14.699,284.462 C-6.660,260.435 -4.498,223.640 19.529,202.280 Z" />
    </svg>
  ),
  shape4: (
...
export default function PageBanner({
  ...
  return (
    <div className="section page-banner-section" style={{ backgroundImage: "url(/assets/images/bg/page-banner.jpg)" }}>
      <div className="shape-1">{PAGE_BANNER_SVG.shape1}</div>
      <div className="shape-2">{PAGE_BANNER_SVG.shape2}</div>
      <div className="shape-3">{PAGE_BANNER_SVG.shape3}</div>
      <div className="shape-4">{PAGE_BANNER_SVG.shape4}</div>
              ...
              <div className="page-banner text-center">
                ...
                <ul className="breadcrumb justify-content-center">
                  <li className="breadcrumb-item">
                    <Link href="/"><span data-lang="vi">Trang chủ</span><span data-lang="en">Home</span></Link>
                  </li>
